...
@class MPAudioDeviceController, MPAudioVideoRoutingActionSheet, MPAudioVideoRoutingPopoverController, SBAirPlayBarView, SBApplication, SBNowPlayingBarView, SBSwitcherVolumeSlider, UIButton, UIViewController;
